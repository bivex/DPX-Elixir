"""Application service for running pattern detection rules against an Elixir CodeModel."""
...
class DetectionService(DetectorPort):
    """Coordinates the execution of all registered Elixir pattern detection rules."""
