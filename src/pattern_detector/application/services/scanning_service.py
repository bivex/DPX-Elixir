"""Application scanning service orchestrating Elixir source retrieval, parsing, and rule execution."""
...
class ScanningService(ScannerPort):
    """End-to-end scanning orchestrator for Elixir / OTP projects."""
    ...
    def scan_path(self, path: str, options: ScanOptions | None = None) -> DetectionReport:
        ...
        sources = self._source_provider.get_sources(path, extensions=[".ex", ".exs"])
