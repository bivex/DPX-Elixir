"""Detection and Report domain entities for Elixir / OTP Pattern Detector."""
...
class Detection:
    """Represents an identified Elixir design pattern, OTP behaviour, idiom, or architecture smell."""

    pattern_type: PatternType
    pattern_category: PatternCategory
    target_name: str
    target_kind: str  # "module", "function", "protocol", "genserver", "supervisor", "context"
...
class DetectionReport:
    """Aggregated findings report of an Elixir codebase scan."""
