"""Base abstractions and protocol for Elixir pattern detection rules."""
...
class PatternRule(Protocol):
    """Protocol that every Elixir pattern detection rule must satisfy."""
...
class BasePatternRule(ABC):
    """Base class for Elixir/OTP pattern rules."""
