"""Inbound (driver) ports for the Elixir pattern detector application layer."""
...
@dataclass
class ScanOptions:
    """Configuration options for an Elixir codebase scan execution."""
...
class ScannerPort(Protocol):
    """Primary inbound port for scanning Elixir codebases and returning DetectionReports."""
...
class DetectorPort(Protocol):
    """Inbound port for executing pattern detection rules on an Elixir CodeModel."""
