"""Dependency Injection container wiring hexagonal ports and adapters for DPX-Elixir."""
...
class Container:
    """IoC container managing singleton services and adapters for DPX-Elixir."""
    ...
    def parser(self) -> ParserPort:
        if self._parser is None:
            self._parser = NativeElixirParserAdapter()
        return self._parser
